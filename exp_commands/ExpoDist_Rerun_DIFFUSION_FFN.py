...
init_exp_list = [
    ...
    dict(
        test_name= "0.0",
        diffusion_noise=1/0.000001,
    ),
    dict(
        test_name= "0.05",
        diffusion_noise=1/0.05,
    ),
    dict(
        test_name= "0.1",
        diffusion_noise=1/0.1,
    ),
    dict(
        test_name= "0.3",
        diffusion_noise=1/0.3,
    ),
    dict(
        test_name= "0.8",
        diffusion_noise=1/0.8,
    ),
    dict(
        test_name= "1.5",
        diffusion_noise=1/1.5,
    ),
    dict(
        test_name= "3.0",
        diffusion_noise=1/3.0,
    ),
    dict(
        test_name= "10.0",
        diffusion_noise=1/10.0,
    ),
]
