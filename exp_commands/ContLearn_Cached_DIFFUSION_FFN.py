...
epoch_and_step = "epoch=999-step=49000"
exp_list = [

    dict(
        test_name= "0.0",
        load_path=f"../scratch_link/Foundational-SDM/wandb_Logger/0.0Baseline_Adam_lr0.0001_datas=None_10000Neurons_projM=False_nlayers1/version_None/checkpoints/{epoch_and_step}.ckpt"
    ),
    dict(
        test_name= "0.05",
        load_path=f"../scratch_link/Foundational-SDM/wandb_Logger/0.05Baseline_Adam_lr0.0001_datas=None_10000Neurons_projM=False_nlayers1/version_None/checkpoints/{epoch_and_step}.ckpt"
    ),
    dict(
        test_name= "0.1",
        load_path=f"../scratch_link/Foundational-SDM/wandb_Logger/0.1Baseline_Adam_lr0.0001_datas=None_10000Neurons_projM=False_nlayers1/version_None/checkpoints/{epoch_and_step}.ckpt"
    ),
    dict(
        test_name= "0.3",
        load_path=f"../scratch_link/Foundational-SDM/wandb_Logger/0.3Baseline_Adam_lr0.0001_datas=None_10000Neurons_projM=False_nlayers1/version_None/checkpoints/{epoch_and_step}.ckpt"
    ),
    dict(
        test_name= "0.8",
        load_path=f"../scratch_link/Foundational-SDM/wandb_Logger/0.8Baseline_Adam_lr0.0001_datas=None_10000Neurons_projM=False_nlayers1/version_None/checkpoints/{epoch_and_step}.ckpt"
    ),
    dict(
        test_name= "1.5",
        load_path=f"../scratch_link/Foundational-SDM/wandb_Logger/1.5Baseline_Adam_lr0.0001_datas=None_10000Neurons_projM=False_nlayers1/version_None/checkpoints/{epoch_and_step}.ckpt"
    ),
    dict(
        test_name= "3.0",
        load_path=f"../scratch_link/Foundational-SDM/wandb_Logger/3.0Baseline_Adam_lr0.0001_datas=None_10000Neurons_projM=False_nlayers1/version_None/checkpoints/{epoch_and_step}.ckpt"
    ),
    dict(
        test_name= "10.0",
        load_path=f"../scratch_link/Foundational-SDM/wandb_Logger/10.0Baseline_Adam_lr0.0001_datas=None_10000Neurons_projM=False_nlayers1/version_None/checkpoints/{epoch_and_step}.ckpt"
    ),
