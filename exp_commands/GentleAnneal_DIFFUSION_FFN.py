...
exp_name_path = "RS=78_Baseline_CIFAR10_Adam_lr0.0001_datas=None_10000Neurons_projM=False_nlayers1" #"Baseline_Adam_lr0.0001_datas=None_10000Neurons_projM=False_nlayers1"
...
for e in init_exp_list: 
    ...
    temp['load_path'] = f"../scratch_link/Foundational-SDM/wandb_Logger/{temp['diffusion_noise']}_{exp_name_path}/version_None/checkpoints/{epoch_and_step}"
